        ...
        resources: {
            en: {
                translations: {
                    ...
                    'thank you': 'thank you',
                    'Payment is successfully processsed and your order is on the way': 'Payment is successfully processsed and your order is on the way',
                    'shipping address': 'shipping address',
                    'order ID': 'order ID',
                    'Order Date': 'Order Date',
                    'Order Total': 'Order Total',
                    'payment method': 'payment method',
                    'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.': 'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.',
                    'expected date of delivery': 'expected date of delivery',
                    'My Cart': 'My Cart',
            ...
            de: {
                translations: {
                    ...
                    'It is mandatory to fill in the field above !': "Das obige Feld ist zwingend auszufüllen!",
                    'It is mandatory to fill in all fields !': "Alle Felder müssen ausgefüllt werden!",
                    'Successfully registered !': "Erfolgreich registriert !",
                    'Unable to register, please try again later !': "Registrierung nicht möglich, bitte versuchen Sie es später noch einmal!",
                    'The name field is required.': "Das Namensfeld ist erforderlich.",
                    'The name must be longer than 3 characters.': "Der Name muss länger als 3 Zeichen sein.",
                    'The password field is required.': "Das Kennwortfeld ist erforderlich.",
                    ...
                    'expected date of delivery': 'expected date of delivery',
                    'My Cart': 'Mein Warenkorb',
                    'PERSONAL DETAIL': 'PERSÖNLICHES DETAIL',
                    'Phone number': 'Telefonnummer',
                    'flat / plot': 'Wohnung / Grundstück',
                    'Address': 'Adresse',
            ...
            es: {
                translations: {
                    ...
                    'my cart': "mi carrito",
                    'It is mandatory to fill in the field above !': "¡Es obligatorio completar el campo de arriba!",
                    'It is mandatory to fill in all fields !': "¡Es obligatorio completar todos los campos!",
                    'Successfully registered !': "Registrado exitosamente !",
                    'Unable to register, please try again later !': "No es posible registrarse. Vuelva a intentarlo más tarde.",
                    'The name field is required.': "El campo de nombre es obligatorio.",
                    'The name must be longer than 3 characters.': "El nombre debe tener más de 3 caracteres.",
                    ...
                    'thank you': 'Danke',
                    'Payment is successfully processsed and your order is on the way': 'Die Zahlung wurde erfolgreich verarbeitet und Ihre Bestellung ist unterwegs',
                    'shipping address': 'Lieferanschrift',
                    'order ID': 'Auftragsnummer',
                    'Order Date': 'Auftragsdatum',
                    'Order Total': 'Auftragssumme',
                    'payment method': 'Zahlungsmethode',
                    'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.': 'Zahlung per Nachnahme (Bar/Karte). Nachnahme (COD) möglich. Karten-/Net-Banking-Akzeptanz vorbehaltlich Geräteverfügbarkeit.',
                    'expected date of delivery': 'Geschätzte Ankunftszeit der Lieferun',
                    'My Cart': 'Mi carrito',
                    'PERSONAL DETAIL': 'DETALLE PERSONAL',
                    'Phone number': 'Número de teléfono',
                    'flat / plot': 'piso / parcela',
                    'Address': 'Habla a',
            ...
            fr: {
                translations: {
                    ...
                    'thank you': "Merci",
                    'Payment is successfully processsed and your order is on the way': "Le paiement est traité avec succès et votre commande est en route",
                    'shipping address': "Adresse de livraison",
                    'order ID': "numéro de commande",
                    'Order Date': "Date de commande",
                    'Order Total': "Total de la commande",
                    'payment method': "mode de paiement",
                    'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.': "Paiement à la livraison (espèces/carte). Paiement à la livraison (COD) disponible. Acceptation de la carte/Net banking sous réserve de disponibilité de l'appareil.",
                    'expected date of delivery': "Date prévue de livraison",
                    'My Cart': 'Mon panier',
                    'PERSONAL DETAIL': 'DÉTAIL PERSONNEL',
                    'Phone number': 'Numéro de téléphone',
                    'flat / plot': 'appartement / parcelle',
                    'Address': 'Adresse',
            ...
            it: {
                translations: {
                    ...
                    'It is mandatory to fill in the field above !': "E' obbligatorio compilare il campo sopra!",
                    'It is mandatory to fill in all fields !': "E' obbligatorio compilare tutti i campi!",
                    'Successfully registered !': "Registrato con successo !",
                    'Unable to register, please try again later !': "Impossibile registrarsi, riprova più tardi!",
                    'The name field is required.': "È richiesto il campo nome.",
                    'The name must be longer than 3 characters.': "Il nome deve essere più lungo di 3 caratteri.",
                    ...
                    'Edit': "Modificare",
                    'dashboard': "Pannello",
                    'your order details': "i dettagli del tuo ordine",
                    'thank you': "grazie",
                    'Payment is successfully processsed and your order is on the way': "Il pagamento è stato elaborato correttamente e il tuo ordine è in arrivo",
                    'shipping address': "indirizzo di spedizione",
                    'order ID': "ID ordine",
                    'Order Date': "Data dell'ordine",
                    'Order Total': "Ordine totale",
                    'payment method': "metodo di pagamento",
                    'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.': "Pagamento alla consegna (Contanti/Carta). Disponibile in contrassegno (COD). Accettazione carta/Net banking soggetta alla disponibilità del dispositivo.",
                    'expected date of delivery': "data di consegna prevista",
                    'My Cart': 'La mia carta',
                    'PERSONAL DETAIL': 'DETTAGLI PERSONALI',
                    'Phone number': 'Numero di telefono',
                    'flat / plot': 'appartamento/appezzamento',
                    'Address': 'Indirizzo',
                    'Zip Code': 'Cap',
                    'Country': 'Paese',
                    'City': 'Città',
            ...
            pt: {
                translations: {
                    ...
                    'thank you': "obrigada",
                    'Payment is successfully processsed and your order is on the way': "O pagamento foi processado com sucesso e seu pedido está a caminho",
                    'shipping address': "endereço de entrega",
                    'order ID': "ID do pedido",
                    'Order Date': "Data do pedido",
                    'Order Total': "total de pedidos",
                    'payment method': "Forma de pagamento",
                    'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.': "Pagamento na entrega (dinheiro/cartão). Dinheiro na entrega (COD) disponível. Aceitação de cartão/net banking sujeita à disponibilidade do dispositivo.",
                    'expected date of delivery': "Data prevista de entrega",
                    'My Cart': 'Meu carrinho',
                    'PERSONAL DETAIL': 'DETALHES PESSOAIS',
                    'Phone number': 'Número de telefone',
                    'flat / plot': 'apartamento / terreno',
                    'Address': 'Endereço',
                    'Zip Code': 'Código postal',
                    'Country': 'País',
                    'City': 'Cidade',
            ...
            sq: {
                translations: {
                    ...
                    'my cart': "karroca ime",
                    'It is mandatory to fill in the field above !': "Është e detyrueshme të plotësoni fushën e mësipërme!",
                    'It is mandatory to fill in all fields !': "Është e detyrueshme plotësimi i të gjitha fushave!",
                    'Successfully registered !': "Regjistruar me sukses!",
                    'Unable to register, please try again later !': "Nuk mund të regjistroheni, ju lutemi provoni përsëri më vonë!",
                    'The name field is required.': "Kërkohet fusha e emrit.",
                    'The name must be longer than 3 characters.': "Emri duhet të jetë më i gjatë se 3 karaktere.",
                    'The password field is required.': "Kërkohet fusha e fjalëkalimit.",
                    ...
                    'My Wishlist': 'Lista ime e dëshirave',
                    ...
                    'Edit': 'Redakto',
                    'dashboard': 'pult',
                    'your order details': 'detajet e porosisë tuaj',
                    'thank you': 'faleminderit',
                    'Payment is successfully processsed and your order is on the way': 'Pagesa u përpunua me sukses dhe porosia juaj është në rrugë e sipër',
                    ...
                    'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.': 'Pagesa me dorëzim (Cash/Card). Paratë në dorëzim (COD) në dispozicion. Pranimi bankar me kartë/Net varet nga disponueshmëria e pajisjes.',
                    'expected date of delivery': 'data e pritur e dorëzimit',
                    'My Cart': 'Karroca ime',
                    'PERSONAL DETAIL': 'DETAJE PERSONALE',
                    'Phone number': 'Numri i telefonit',
                    'flat / plot': 'banesë / truall',
                    'Address': 'Adresë',
                    'Zip Code': 'Kodi Postal',
                    'Country': 'Vendi',
                    'City': 'Qyteti',
                    'Region/State': 'Rajoni/Shteti',
                    'SHIPPING ADDRESS': 'ADRESA E DËRGIMIT',
                    'Save setting': 'Ruaj cilësimin',
            ...
            zh: {
                translations: {
                    ...
                    'my cart': "我的车",
                    'It is mandatory to fill in the field above !': "必须填写上面的字段！",
                    'It is mandatory to fill in all fields !': "必须填写所有字段！",
                    'Successfully registered !': "注册成功！",
                    'Unable to register, please try again later !': "无法注册，请稍后重试！",
                    'The name field is required.': "名称字段是必需的。",
                    'The name must be longer than 3 characters.': "名称必须超过 3 个字符。",
                    ...
                    'thank you': '谢谢',
                    'Payment is successfully processsed and your order is on the way': '付款已成功处理，您的订单正在处理中',
                    'shipping address': '送货地址',
                    'order ID': '订单编号',
                    'Order Date': '订购日期',
                    'Order Total': '合计订单',
                    'payment method': '付款方法',
                    'Pay on Delivery (Cash/Card). Cash on delivery (COD) available. Card/Net banking  acceptance subject to device availability.': '货到付款（现金/卡）。货到付款 (COD) 可用。卡/网上银行接受取决于设备的可用性。',
                    'expected date of delivery': '预计交货日期',
                    'My Cart': '我的车',
                    'PERSONAL DETAIL': '个人资料',
                    'Phone number': '电话号码',
                    'flat / plot': '平面/情节',
                    'Address': '地址',
                    'Zip Code': '邮政编码',
