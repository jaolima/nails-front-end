...
const Login = () => {
    ...
    const googleAuth = async () => {
        try {
            ...
            setTimeout(() => {
                toast.error(t("Oppss.. The password is invalid or the user does not have a password."));
            }, 200);
        }
    };
                        ...
                        <Col lg="6">
                            ...
                            <div className="theme-card">
                                <Form className="theme-form">
                                    ...
                                    <a href="#" className="btn btn-solid" onClick={() => loginAuth(email,password)}>{t('Login')}</a>
